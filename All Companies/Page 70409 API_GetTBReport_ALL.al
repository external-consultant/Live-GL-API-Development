page 70409 API_GetTBReport_ALL
{
    APIGroup = 'API';
    APIPublisher = 'ISPL';
    APIVersion = 'v2.0';
    ...
    DelayedInsert = true;
    EntityName = 'apiGetTBReportALL';
    EntitySetName = 'apiGetTBReportALL';
    ODataKeyFields = SystemId;
    PageType = API;
    SourceTable = GLAPIData_TB_ALL;
    ...
    var
        // Report70400: Report GLAPIDataBatch_TB_ALL;//TB Report 
        Report70400: Report "GLAPIDataDetailed TB Report";
        startDate: Date;
        endDate: Date;
    begin
