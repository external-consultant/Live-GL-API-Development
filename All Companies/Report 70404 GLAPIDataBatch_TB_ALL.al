report 70404 GLAPIDataBatch_TB_ALL   //Not using this report in the API-Anoop
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    ProcessingOnly = true;
    Description = 'Final-TBALL';
    ...
    dataset
    {
        dataitem(Company; Company)
        {
            ...
            var
                myInt: Integer;
            begin
                // SetFilter(Name, '<>%1|%2', 'Coraplus India_1', 'Chemiprime Impex_1');//ABA they need to filter out the company name from the list of companies.Vestcorp|Unipin->skip the India Company
            end;
