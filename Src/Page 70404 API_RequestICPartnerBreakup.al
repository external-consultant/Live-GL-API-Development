...
page 70404 API_RequestICPartnerBreakup
{
    ...
    DelayedInsert = true;
    EntityName = 'apiRequestICPartnerBreakup';
    EntityCaption = 'apiRequestICPartnerBreakup';
    EntitySetName = 'apiRequestICPartnerBreakups';    //Make Sure First Char in Small Letter and don't use any special char or space
    EntitySetCaption = 'apiRequestICPartnerBreakups';
    PageType = API;
    ...
    var
        Report70400: Report GLAPIDataBatch_ICPartner;
